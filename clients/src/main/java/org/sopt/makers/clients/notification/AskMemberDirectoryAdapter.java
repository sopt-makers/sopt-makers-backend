...
@Component
public class AskMemberDirectoryAdapter implements AskMemberDirectoryPort {
  ...
  public AskMemberDirectoryAdapter(@Value("${spring.profiles.active:}") String activeProfile) {
