...
//  - 포트(domain-app AppHomePlaygroundPostQueryPort)와 홈 쪽 호출부는 그대로 두고 이 클래스만 바꾼다.
...
public class AppHomePlaygroundPostQueryAdapter implements AppHomePlaygroundPostQueryPort {
  ...
  public AppHomePlaygroundPostQueryAdapter(PlaygroundProperty playgroundProperty) {
