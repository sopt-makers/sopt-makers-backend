...
-- ============================================================
-- Resolution(다짐/럭키픽) 도메인 — domain-playground/resolution/*
-- ============================================================
...
(
    ...
    updated_at      TIMESTAMP    NOT NULL,
    PRIMARY KEY (id),
    CONSTRAINT fk_user_resolution_user FOREIGN KEY (user_id) REFERENCES users (id)
);
...
(
    ...
    updated_at TIMESTAMP NOT NULL,
    PRIMARY KEY (id),
    CONSTRAINT uk_user_resolution_lucky_pick_user UNIQUE (user_id),
    CONSTRAINT fk_user_resolution_lucky_pick_user FOREIGN KEY (user_id) REFERENCES users (id)
);
