...
public interface AdminOfficialApi {
  ...
  ResponseEntity<BaseResponse<?>> confirmCommonData(AdminOfficialRequest.ConfirmRequest request);

  @Operation(
      summary = "홈 탭 데이터 전달",
      description = "홈 헤더 이미지, 뉴스, 후기 정보를 캐시에 저장하고 presigned URL을 반환합니다.")
  ...
  ResponseEntity<BaseResponse<?>> confirmHomeData(AdminOfficialRequest.ConfirmRequest request);

  @Operation(
      summary = "소개 탭 데이터 전달",
      description = "소개 헤더 이미지, 핵심가치, 멤버, 활동일정 정보를 캐시에 저장하고 presigned URL을 반환합니다.")
  ...
  ResponseEntity<BaseResponse<?>> confirmAboutData(AdminOfficialRequest.ConfirmRequest request);

  @Operation(
      summary = "모집안내 탭 데이터 전달",
      description = "모집 헤더 이미지, 파트 소개, 커리큘럼, FAQ 정보를 캐시에 저장하고 presigned URL을 반환합니다.")
  ...
  ResponseEntity<BaseResponse<?>> confirmRecruitData(AdminOfficialRequest.ConfirmRequest request);
}
