...
public interface AdminOfficialApi {
  ...
  ResponseEntity<BaseResponse<?>> getAdminMain(Integer generationId);
  ...
  ResponseEntity<BaseResponse<?>> confirmCommonData(Integer generationId);
  ...
  ResponseEntity<BaseResponse<?>> confirmHomeData(Integer generationId);
  ...
  ResponseEntity<BaseResponse<?>> confirmAboutData(Integer generationId);
  ...
  ResponseEntity<BaseResponse<?>> confirmRecruitData(Integer generationId);
}
