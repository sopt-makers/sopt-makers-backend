...
public record MemberRecommendResponse(List<RecommendedMember> members) {
  ...
  public static MemberRecommendResponse from(List<MemberRecommendation> recommendations) {
    List<RecommendedMember> members =
        recommendations.stream()
            ...
            .toList();
    return new MemberRecommendResponse(members);
  }
}
