...
public record RandomProjectResponse(
    ...
    @Schema(description = "활동 정보 (앱잼, 솝커톤 등)", requiredMode = Schema.RequiredMode.REQUIRED)
        String category,
    @Schema(
            description = "플랫폼 정보 (iOS, Android, Web 등)",
            requiredMode = Schema.RequiredMode.REQUIRED)
        List<String> serviceType,
    @Schema(description = "활동 시작일") LocalDate startAt,
    @Schema(description = "활동 종료일") LocalDate endAt,
    @Schema(description = "서비스 운영 여부") Boolean isAvailable,
    @Schema(description = "창업 여부") Boolean isFounding,
