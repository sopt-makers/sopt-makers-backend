...
public sealed interface AdminAuthRequest {
  ...
  record AdminSignUp(String email, String password, String name, AdminAccountType accountType)
      implements AdminAuthRequest {}

  record AdminLogin(String email, String password) implements AdminAuthRequest {}
