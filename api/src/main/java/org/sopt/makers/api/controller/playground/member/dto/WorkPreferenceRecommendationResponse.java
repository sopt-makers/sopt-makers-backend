...
public record WorkPreferenceRecommendationResponse(
  ...
  public record RecommendedMember(
      ...
      String profileImage,
      String university,
      MemberProfileResponse.MemberSoptActivityResponse activity,
  ...
  private static RecommendedMember toRecommendedMember(WorkPreferenceRecommendedMember member) {
    ...
    MemberProfileResponse.MemberSoptActivityResponse activityResponse =
        activity == null
            ? null
            : new MemberProfileResponse.MemberSoptActivityResponse(
                activity.id(),
                activity.generation(),
