...
class MemberSortingServiceTest {

  private final MemberSortingService service =
      new MemberSortingService(
          new DefaultProfileWeightStrategy(),
          new EmployedProfileWeightStrategy(),
          new DefaultMemberComparator(),
          new EmployedMemberComparator(),
          new TeamActivityMemberComparator(),
          new OrderByMemberComparator());
