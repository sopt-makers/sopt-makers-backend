...
public class MemberSortingService {
  ...
  public Comparator<User> createComparator(Integer employed, Team teamFilter) {
    ...
    MemberSortingComparator sortingComparator = selectSortingComparator(employed, teamFilter);
  ...
  public Comparator<User> createComparatorByOrderCondition(ProfileOrderBy orderBy, Integer employed) {
    ...
    ProfileWeightStrategy weightStrategy = selectWeightStrategy(employed);
    MemberSortingComparator comparator = orderByMemberComparator.withOrderBy(orderBy);
  ...
  private MemberSortingComparator selectSortingComparator(Integer employed, Team teamFilter) {
