...
public class UserResolutionService {
    ...
    public ResolutionResult getResolution(Long userId) {
        ...
        boolean hasDrawnLuckyPick = userResolutionLuckyPickRepositoryPort.existsByUserIdAndHasDrawnTrue(userId);
        return userResolutionRepositoryPort.findByUserIdAndGeneration(userId, CURRENT_GENERATION)
    ...
    public void createResolution(Long userId, String content, List<ResolutionTag> tags) {
        ...
        userResolutionRepositoryPort.save(new UserResolution(null, userId, content, CURRENT_GENERATION, tags));
    }
    ...
    public void deleteResolution(Long userId) {
        ...
        UserResolution resolution = userResolutionRepositoryPort
