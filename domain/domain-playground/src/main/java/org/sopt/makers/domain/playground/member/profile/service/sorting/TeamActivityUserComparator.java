...
@Component
public class TeamActivityUserComparator implements UserSortingComparator {

  private final Team targetTeam;

  public TeamActivityUserComparator() {
    this.targetTeam = null;
  }

  private TeamActivityUserComparator(Team targetTeam) {
    this.targetTeam = targetTeam;
  }

  public TeamActivityUserComparator withTeam(Team team) {
    return new TeamActivityUserComparator(team);
  }
