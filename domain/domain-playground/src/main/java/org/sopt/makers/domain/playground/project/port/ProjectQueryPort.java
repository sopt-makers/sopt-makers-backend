...
public interface ProjectQueryPort {
    ...
    List<Project> findProjects(Integer limit, Long cursor, String searchWord, String category,
            Boolean isAvailable, Boolean isFounding, Integer generation);

    int countAllProjects(String searchWord, String category, Boolean isAvailable,
