...
public class ProjectQueryRepository {
    ...
    public List<Project> findProjects(Integer limit, Long cursor, String searchWord,
        ...
        JPAQuery<ProjectEntity> query = queryFactory.selectFrom(project)
                .where(
                        ltProjectId(cursor),
    ...
    public int countProjectsExcludeSopkathon(Long memberId) {
        ...
        Long count = queryFactory.select(project.id.countDistinct())
                .from(project)
                .innerJoin(projectMember).on(projectMember.projectId.eq(project.id))
                .where(
                        projectMember.userId.eq(memberId),
    ...
    public List<Project> findRandomProjects(int limit) {
        ...
        return queryFactory.selectFrom(project)
                ...
                .limit(limit)
                .fetch().stream().map(e -> e.toDomain()).toList();
    }
